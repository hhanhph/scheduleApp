if (!self.define) {
  ...
  self.define = (i, r) => {
    ...
    s[a] = Promise.all(i.map((e) => o[e] || c(e))).then((e) => (r(...e), t));
  };
}
define(["./workbox-22294e6b"], function (e) {
  "use strict";
  importScripts(
    "worker-FX8sqTCePimYbhKzmLvoC.js",
    "fallback-FX8sqTCePimYbhKzmLvoC.js"
  ),
    self.skipWaiting(),
    e.clientsClaim(),
    e.precacheAndRoute(
      [
        ...
        {
          url: "/_next/static/FX8sqTCePimYbhKzmLvoC/_buildManifest.js",
          revision: "FX8sqTCePimYbhKzmLvoC",
        },
        {
          url: "/_next/static/FX8sqTCePimYbhKzmLvoC/_ssgManifest.js",
          revision: "FX8sqTCePimYbhKzmLvoC",
        },
        {
        ...
        {
          url: "/_next/static/chunks/pages/index-c7e03e9e7a0c8a5d79d3.js",
          revision: "FX8sqTCePimYbhKzmLvoC",
        },
        {
        ...
        { url: "/_offline", revision: "FX8sqTCePimYbhKzmLvoC" },
        {
